      ...
      <section className="text-gray-600 body-font bg-[#1f2833]">
        <div className="container mx-auto flex px-5  py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-[#66fcf1] ">
              I am
            ...
            <div className="flex justify-center">
              <Link href={"#Contact"}>
                {" "}
                <button className="inline-flex text-white bg-[#1f2833] border-2 border-[#66fcf1] py-2 px-6 focus:outline-none hover:bg-[#66fcf1] hover:text-[#1f2833] hover:border-[#1f2833] rounded text-lg">
                  Contact
                </button>
              </Link>
            </div>
